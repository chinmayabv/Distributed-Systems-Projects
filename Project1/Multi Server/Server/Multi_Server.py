...
from thread import *
Buffer_Size = 1024
Server_Directory ="/home/chinmaya/Downloads/Single_and_multi_client_server/Multi Server/Server/" 
...
def main():
    ...
    while True:
        ...
        start_new_thread(thread, (link, link_path))
